    ...
    <div className="min-h-screen bg-[#f8f9ff] text-[#0b1c30] flex font-sans">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <header className="h-20 bg-white border-b border-[#c3c6d7]/40 px-8 flex justify-between items-center sticky top-0 z-10 shadow-xs">
          <h2 className="text-xl font-bold text-[#0b1c30]">System Settings</h2>
        ...
        <div className="p-8 space-y-6 max-w-4xl mx-auto w-full">
          <div>
            <h3 className="text-2xl font-extrabold text-[#0b1c30]">Pengaturan Akun</h3>
            <p className="text-sm text-[#516070] mt-1">Kelola informasi profil dan keamanan akses administrator.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
            
            {/* KARTU PROFIL */}
            <div className="bg-white border border-[#c3c6d7]/40 rounded-2xl shadow-sm p-7">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#004ac6] to-[#002f80] text-white flex items-center justify-center font-bold text-2xl shadow-lg shadow-[#004ac6]/20">
                  {getInitials(userName)}
                </div>
                <div>
                  <h4 className="text-lg font-bold text-[#0b1c30]">Profil Pengguna</h4>
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                <div>
                  <label className="block text-xs font-bold text-[#516070] mb-2 uppercase tracking-wide">Nama Lengkap</label>
                  <input 
                    type="text" 
                    value={newUserName}
                    onChange={(e) => setNewUserName(e.target.value)}
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#004ac6]/50 focus:border-[#004ac6] transition outline-none text-sm font-medium text-gray-800"
                  />
                </div>
                <button 
                  type="submit" 
                  className="w-full py-3 bg-[#004ac6] text-white rounded-xl text-sm font-bold hover:bg-[#003998] transition shadow-md shadow-[#004ac6]/20 mt-2"
                >
                  Simpan Perubahan
                </button>
              </form>
            ...
            <div className="bg-white border border-[#c3c6d7]/40 rounded-2xl shadow-sm p-7">
              <div className="mb-6 pb-6 border-b border-gray-100">
                <h4 className="text-lg font-bold text-[#0b1c30]">Keamanan Akses</h4>
                <p className="text-xs text-[#516070]">Perbarui password secara berkala</p>
              </div>

              <form onSubmit={handleUpdatePassword} className="space-y-4">
                <div>
                  <label className="block text-xs font-bold text-[#516070] mb-2 uppercase tracking-wide">Password Saat Ini</label>
                  <div className="relative">
                    <input 
                      ...
                      placeholder="••••••••"
                      className="w-full px-4 py-3 pr-10 rounded-xl border border-gray-300 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-[#004ac6]/50 focus:border-[#004ac6] transition outline-none text-sm"
                    />
                    <button 
                      type="button" 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-[#516070] mb-2 uppercase tracking-wide">Password Baru</label>
                    <div className="relative">
                      <input 
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#516070] mb-2 uppercase tracking-wide">Konfirmasi</label>
                    <div className="relative">
                      <input 
                ...
                <button 
                  type="submit" 
                  className="w-full py-3 bg-white text-[#004ac6] border-2 border-[#004ac6] rounded-xl text-sm font-bold hover:bg-[#e5eeff] transition mt-2"
                >
                  Perbarui Password
                </button>
              </form>
